...
couches_lineaires = [(2.0 - 0j, 100e-9)] #Liste des tuples (indice, epaisseur) des couches linéaires précédent le semiconducteur, laisser vide si seulement air
...
amplitude = 1e6 #[V/m] amplitude maximale du champ électrique du pulse d'entrée
...
plt.savefig(f'{results_folder}figure/propagation_{amplitude:.2e}.png')
print(f"\nGraphique sauvegardé sous '{results_folder}figure/propagation_{amplitude:.2e}.png'")
...
# Sauvegarder le graphique
plt.savefig(f'{results_folder}figure/neff_{amplitude:.2e}.png')
print(f"\nGraphique sauvegardé sous '{results_folder}figure/neff_{amplitude:.2e}.png'")
